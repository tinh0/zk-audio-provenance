...
fn fold_fold_fold(selected_function: String,
    ...
    if resolution == "8K" {
        iteration_count = 4976;
    }
    if resolution == "19" {
        iteration_count = 512;
    }
    if resolution == "20" || resolution == "21" {
        iteration_count = 1024;
    }
    if resolution == "22" || resolution == "23" {
        iteration_count = 2048;
    }
    if resolution == "24" || resolution == "25" {
...
fn main() {
    let matches = App::new("VIMz")
        ...
        .arg(
            ...
            .takes_value(true)
            .possible_values(&["SD", "HD", "FHD", "4K", "8K", "19", "20", "21", "22", "23", "24", "25"])
        )
        .get_matches();
